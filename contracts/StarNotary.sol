...
contract StarNotary is ERC721 {
    ...
    string private name_ = "SolskiToken";
    string private symbol_ = "SOLA";
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        //I could use transfer to bypass the approval, but since the exercise wants transferFrom, I used it instead
